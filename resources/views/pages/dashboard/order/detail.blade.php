        ...
        <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
            <div class="col-span-8">
                ...
                <p class="text-sm text-gray-400">
                    {{ auth()->user()->service()->count() }} Total Layanan
                </p>
            </div>
    ...
    <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
        <ol class="inline-flex p-0 list-none">
            <li class="flex items-center">
                <a href="{{ route('member.service.index') }}" class="text-gray-400">Layanan Saya</a>
                <svg class="w-3 h-3 mx-3 text-gray-400 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                    <path d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z" />
                </svg>
            </li>
            <li class="flex items-center">
                <p class="font-medium">Detail Layanan</p>
            </li>
        </ol>
    </nav>
                    ...
                    <section class="pt-6 pb-20 mx-8 w-auth">
                        <div class="grid gap-5 md:grid-cols-12">
                            <main class="p-4 lg:col-span-7 md:col-span-12">
                                <span class="inline-flex items-center justify-center px-3 py-2 mb-4 mr-2 text-xs leading-none text-green-500 rounded-full bg-serv-green-badge">Aktif</span>
                                ...
                                <div class="p-3 my-4 bg-gray-100 rounded-lg image-gallery" x-data="gallery()">
                                    ...
                                    <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                                        <div class="flex mt-2 flex-nowrap">
                                            ...
                                            <img :class="{ 'border-4 border-serv-button': active === {{ $item->id }} }" @click="changeThumbnail('{{ url(Storage::url($item->thumbnail)) }}', {{ $item->id }})" src="{{ url(Storage::url($item->thumbnail)) }}" alt="thumbnail layanan" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                            @empty
                                            {{-- kosong --}}
                                            @endforelse
                                ...
                                <div class="content">
                                    <div>
                                        ...
                                        <div class="leading-8 text-md">
                                            <h2 class="text-xl font-semibold">Tentang <span class="text-serv-button">Layanan Ini</span></h2>
                                            <div class="mt-4 mb-8 content-description">
                                                <p>
                                                    {{ $order->service->description ?? '' }}
                                                </p>
                                            </div>
                                            <h3 class="my-4 text-lg font-semibold">Mengapa memilih Layanan saya?</h3>
                                ...
                                <div class="mb-4 border rounded-lg border-serv-testimonial-border">
                                    <div class="flex items-center px-2 py-3 mx-4 mt-4 border rounded-full border-serv-testimonial-border">
                                        <div class="flex-1 text-sm font-medium text-center">
                                            ...
                                            {{ $order->service->delivery_time ?? '' }} Hari Pengiriman
                                        </div>
                                        <div class="flex-1 text-sm font-medium text-center">
                                            <svg class="inline" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            {{ $order->service->revision_limit ?? '' }} Batas Revisi
                                        </div>
                                    </div>
                                    <div class="px-4 pt-4 pb-2 features-list">
                                        <ul class="mb-4 text-sm list-check">
                                            <li class="pl-10 my-4">3 Halaman</li>
                                            <li class="pl-10 my-4">Desain Kustom</li>
                                            <li class="pl-10 my-4">Desain Responsif</li>
                                            <li class="pl-10 my-4">3 Plugin/Ekstensi</li>
                                            <li class="pl-10 my-4">Fungsi E-Commerce</li>
                                        </ul>
                                    </div>
                                    <div class="px-4">
